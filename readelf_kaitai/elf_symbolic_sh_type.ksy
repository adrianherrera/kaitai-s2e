#
# This ELF declaration makes the e_machine symbolic.
#
...
meta:
  ...
  ks-version: 0.8
#
# The elf constructor must also take the S2E execution state and input file's
# start address as arguments
#
params:
  - id: s2e_state
  - id: start_addr
seq:
  ...
  - id: pad
    size: 7
  #
  # Propagate the S2E execution state and input file's start address to the
  # endian_elf type
  #
  - id: header
...
types:
  endian_elf:
    #
    # The endian_elf constructor also take the S2E execution state and input
    # file's start address as arguments so that they can be passed to
    # s2e_make_symbolic
    #
    params:
      - id: s2e_state
    ...
    types:
      ...
      section_header:
        #
        # Pass the S2E execution state and input file's start address to the
        # section header's constructor
        #
        params:
          - id: s2e_state
          - id: start_addr
        seq:
          ...
          - id: name_offset
            type: u4
          #
          # Make the type attribute symbolic
          #
          - id: type
            size: 4
    ...
    instances:
      ...
      section_headers:
        ...
        #
        # Propagate the S2E execution state and input file's start address to
        # to the section_header parser
        #
